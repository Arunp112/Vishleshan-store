...
const MyState = (props) => {
  ...
  return (
    <MyContext.Provider value={{mode,toggleMode,loading,setLoading,products,setProducts,addproduct,product,edithandle,deleteProduct,updateProduct,order}}>{props.children}</MyContext.Provider>
  )
}
